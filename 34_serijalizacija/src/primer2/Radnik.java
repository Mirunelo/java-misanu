...
public class Radnik implements Serializable{
	 ...
	 * član.
	 */
	private static final long serialVersionUID = -2052298201219211005L;
	
	// Statički i transient podaci se ne čuvaju u procesu serijalizacije!
	transient int a;
	static int b;
	
	// nonstatic promenljive će se sačuvati u procesu serijalizacije.
	String ime;
	int godine;
	
	// Konstruktor
	public Radnik(String ime, int godine, int a, int b) {
		this.ime = ime;
		this.godine = godine;
		this.a = a;
		Radnik.b = b;
